...
//    val pipelineModelPath = args(2)
    val inputPath = "file:///Users/dinglei/javaProjects/CtrOnSpark/src/main/resources/demo/data/iris.csv"
    val nativeModelPath = "/tmp/nativeModel"

    val spark = SparkSession.builder().appName("XGBoost4J-Spark").getOrCreate()
